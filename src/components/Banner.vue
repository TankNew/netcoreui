  ...
  <section class="container-fluid">
    ...
    <div class="my-3">
      ...
      <ul class="banner-choose">
        <li v-for="(item,index) in pages" :key="index" :class="item.name==currentPage.name?'active':''"
            @click="bindCurrentPage(item)">{{item.name}}</li>
      </ul>
    </div>
    <div class="row">
      ...
      <div class="col-3 banner-tools py-3">
        ...
        <div>
          <b-form-group horizontal
                        label="宽度:"
                        label-class="text-sm-right" label-size="sm"
          ...
          <b-form-group horizontal
                        label="高度:"
                        label-class="text-sm-right" label-size="sm" append="px"
        ...
        <div>
          ...
          <b-form-group horizontal
            ...
            <b-form-textarea id="nestedCountry"
        ...
        pages: [
          {
            ...
            height: 600,
            imgs: [
              { img: 'https://picsum.photos/1024/480/?image=52', url: '', title: '虚拟主机', text: '独立主机，多重安全防护，本地线路更流畅', column: '左侧', row: '居中' },
              { img: 'https://picsum.photos/1024/480/?image=54', url: '', title: 'abc', text: '独立主机，多重安全防护，本地线路更流畅', column: '左侧', row: '居中' },
              { img: 'https://picsum.photos/1024/480/?image=58', url: '', title: 'tt', text: '独立主机，多重安全防护，本地线路更流畅', column: '左侧', row: '居中' }
            ]
          },
          {
            name: '公司简介',
            ...
            imgs: [
              { img: 'https://picsum.photos/1024/480/?image=52', url: '', title: '虚拟主机', text: '独立主机，多重安全防护，本地线路更流畅', column: '左侧', row: '居中' },
              { img: 'https://picsum.photos/1024/480/?image=54', url: '', title: '虚拟主机', text: '独立主机，多重安全防护，本地线路更流畅', column: '左侧', row: '居中' },
              { img: 'https://picsum.photos/1024/480/?image=58', url: '', title: '虚拟主机', text: '独立主机，多重安全防护，本地线路更流畅', column: '左侧', row: '居中' }
            ]
          }
        ],
        banners: [],
...
<style scoped>
  ...
  .banner-tools { background-color: #374459; color: #fff; }
    .banner-tools > h5 { text-align: center; font-size: 80%; background-color: rgba(255,255,255,.3); padding: 5px 0; color: #007bff; }
  .banner-choose { list-style: none; display: inline-block; padding: 0; margin: 0; text-align: center; }
    .banner-choose > li { list-style: none; display: inline-block; height: 40px; width: 100px; border: 1px solid #e9ecef; line-height: 38px; margin: 5px; border-radius: 4px; font-size: 12px; cursor: pointer; }
      .banner-choose > li:hover, .banner-choose > li.active { background-color: #007bff; color: #fff; }
</style>
