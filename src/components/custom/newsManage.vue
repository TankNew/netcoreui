        ...
        <section v-if="editMode" style="height:100%; position:relative;">
            ...
            >
                ...
                <div class="news-toolbar">
                    ...
                    <button
                        type="button"
                        :class="['btn',editModeWidth==640?'btn-secondary':'btn-light']"
                        @click="putEditModeWidth(640)"
                    >640</button>
                    <button
                        type="button"
                        :class="['btn',editModeWidth==800?'btn-secondary':'btn-light']"
                        @click="putEditModeWidth(800)"
                    >800</button>
                    <button
                        type="button"
                        :class="['btn',editModeWidth==900?'btn-secondary':'btn-light']"
                        @click="putEditModeWidth(900)"
                    >900</button>
                    <button
                        type="button"
                        :class="['btn',editModeWidth==1000?'btn-secondary':'btn-light']"
                        @click="putEditModeWidth(1000)"
                    >1000</button>
                    <button
                        type="button"
                        :class="['btn',editModeWidth==1200?'btn-secondary':'btn-light']"
                        @click="putEditModeWidth(1200)"
                    >1200</button>
                </div>
...
export default {
    data() {
        return {
            ...
            form: {},
            formModel: {},
            categorys: [{ text: '选择分类', value: null }, '通知', '重要通知', '公告', '特别公告'],
            //无用设置tinymce
            editorInit: {
                selector: 'editor',
                inline: true
    ...
    watch: {
        ...
        editMode(val) {
            ...
            else this.$refs.tinymceNews.destroy()
            //刷新滚动轴
            that.refreshScroll()
        },
        perPage() {
